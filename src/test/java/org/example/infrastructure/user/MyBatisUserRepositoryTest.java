...
public class MyBatisUserRepositoryTest {
    ...
    void save_user_generate_id() {
        Integer userRoleId = this.roleRepository.findRoleByName("USER").getId();
        User user = new User(userRoleId,"testName","test@example.com");   this.userRepository.save(user);
    ...
    void not_save_registered_user_fail() {
        Integer userRoleId = this.roleRepository.findRoleByName("USER").getId();
        User user = new User(userRoleId,"testName","test@example.com");
        User registeredUser = new User(userRoleId,"testName","test@example.com");
        this.userRepository.save(user);
